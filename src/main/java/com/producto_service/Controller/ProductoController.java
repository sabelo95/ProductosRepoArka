...
public class ProductoController {
    ...
    @Operation(summary = "Crear producto", description = "Crea un nuevo producto en el sistema. Requiere rol de ADMINISTRADOR")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> crearProducto(@Valid @RequestBody RequestProductoDto productoDto) {
        try {
